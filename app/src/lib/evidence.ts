/* 살피 근거 데이터. SaaS 5종, 2026.8 각 벤더 공개 관리자 문서 조사. 워크벤치와 콘솔이 공유 */
export interface EvidenceEntry { layer: 'L1'|'L2'|'L3'; feature: string; exists: string; control: string; control_availability: 'builtin'|'higher_tier'|'third_party'|'none'|'unclear'; plan_note?: string; source_url: string; source_quote?: string; confidence?: string; [k: string]: unknown }
export interface EvidencePack { saas: string; entries: EvidenceEntry[] }
export const EVIDENCE: EvidencePack[] = [
 {
